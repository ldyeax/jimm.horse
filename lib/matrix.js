...
class Matrix {
	...
	*/
	...
	processImage() {
        ...
        console.log(`image: ${image.width}x${image.height} canvas: ${canvas.width}x${canvas.height}`);
		ctx.drawImage(this.#image, 0, 0, canvas.width, canvas.width * this.#height / image.height);
