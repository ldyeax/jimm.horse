...
?>
	<div class=icon>
		<img src="/img/CLIPLY_372109260_TWITTER_LOGO_400.gif" alt="Twitter" height=150 data-source="https://cliply.co/clip/twitter-logo/" usemap="#twittermaparea">
		<map name="twittermap">
			<area id="twittermaparea" shape="poly" 
