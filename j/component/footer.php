...
?>
	<div class=icon>
		<img src="/img/CLIPLY_372109260_TWITTER_LOGO_400.gif" alt="Twitter" height=150 longdesc="https://cliply.co/clip/twitter-logo/" usemap="#twittermap">
		<map name="twittermap">
			<area id="area" shape="poly" 
